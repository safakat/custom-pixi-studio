    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/10 via-background to-accent/10 py-12">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Robotic Gantry Palletizer System</h1>
          <p className="text-xl text-muted-foreground">The pinnacle of industrial automation for multi-SKU palletizing</p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Mozi Tronics Robotic Gantry Palletizer represents the pinnacle of industrial automation for multi-SKU palletizing.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                It automates the entire end-of-line workflow — from CBB infeed, SKU identification, and separation to traffic management and robotic pallet stacking.
              </p>
            </div>
          </div>
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle>Advantages Over Cobots / Articulated Robots</CardTitle>
            </CardHeader>
            <CardContent>
